...
export const signInFail = (error) => createAction(
    USER_ACTION_TYPES.SIGN_IN_FAILURE,
    error
)

export const signUpStart = (email, password, displaName) => createAction(
    USER_ACTION_TYPES.SIGN_UP_START,
    { email, password, displaName }
);
...
export const signUpFail = (error) => createAction(
...
export const signOutFail = (error) => createAction(
